            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('admin.account.index')}}" class="menu-link">
                    <div data-i18n="Without menu">List Account</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('admin.account.addAccount')}}" class="menu-link">
                    <div data-i18n="Without navbar">Add Account</div>
                  </a>
                </li>
              </ul>
            </li>
             ...
             <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('admin.category.addCategory')}}" class="menu-link">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('admin.product.index')}}" class="menu-link">
                    <div data-i18n="Account">List Product</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('admin.product.addProduct')}}" class="menu-link">
